...
public class Headgear extends Armor {
	...
	public static Headgear getHeadgearRandRarity(String level) {
		String type = "head";
		...
		return new Headgear(strength, dexterity, stamina, wrath, type, level, name, armor);
	}
	
	private Headgear(int str, int dex, int stam, int wrath, String type, String level, String name, int armor) {
